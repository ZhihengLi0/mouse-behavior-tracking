#!/usr/bin/env python3
"""Pupil trace with blink handling (2026-09-19).
...
H5 = sys.argv[1] if len(sys.argv) > 1 else sorted(glob.glob(str(ROOT / "active-learning/training-data/face_first4minDLC*shuffle60*.h5")))[-1]

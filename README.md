...
## Status (last updated 2026-09-25 02:05 CDT)
...
| In progress | **video 4** (Pluto, 2025-10-30, poor image quality): 80 labels = 16.40 px, still improving (4.4% over 60 labels); batch 5 (100 labels) selected, waiting for labeling |
